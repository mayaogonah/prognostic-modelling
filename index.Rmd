...
**Description:** This file includes R code for the development and internal validation of a survival prognostic model which seeks to predict the risk of violent victimisation following adolescent TBI. This document is a shortened version of the original R code, aimed at illustrating key steps in the model development and internal validation. It has also been edited in line with SAIL Databank's output review policy.
